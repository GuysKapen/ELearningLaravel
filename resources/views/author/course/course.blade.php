...
<div class="accordion" id="accordionExample">
    ...
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingOne">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
        ...
        <div id="collapseOne" class="transition-all duration-1000 collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
    ...
    <!-- Détails chapitre 1 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingTwo">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
    ...
    <!-- Détails chapitre 2 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingThree">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                ...
                <a href="actualvideocontent_learninglad.php?video=17">&#10170 C++ Logical and Comparison
                    Operators</a><br>
                <a href="actualvideocontent_learninglad.php?video=18">&#10170 C++ Ternary Operator (Conditional
                    Operator)</a><br>
    ...
    <!-- Détails chapitre 3 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingFour">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                ...
                <a href="actualvideocontent_learninglad.php?video=30">&#10170 C++ Continue Statement with
                    Example</a><br>
                <a href="actualvideocontent_learninglad.php?video=52">&#10170 For Each Loop | Range Based For
                    Loop </a><br>
            </div>
        </div>
    </div>
    <!-- Détails chapitre 4 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingFive">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                ...
                <a href="actualvideocontent_learninglad.php?video=23">&#10170 Two Dimensional ( 2D ) and
                    Multidimensional Arrays in CPP</a><br>
            </div>
        </div>
    </div>
    <!-- Détails chapitre 5 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingSix">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
                        data-target="#collapseSix" aria-expanded="false" aria-controls="collapseFour">
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                ...
                <a href="actualvideocontent_learninglad.php?video=25">&#10170 CPP Function Parameters | Returning Values
                    from Functions </a><br>
                ...
                <a href="actualvideocontent_learninglad.php?video=39">&#10170 Const Keyword with Functions and Arrays in
                    C++ with Example</a><br>
                <a href="actualvideocontent_learninglad.php?video=48">&#10170 New and Delete Operators in C++ | Dynamic
                    Memory Allocation</a><br>
                <a href="actualvideocontent_learninglad.php?video=49">&#10170 Dynamically Allocating Arrays Depending on
                    User Input in C++</a><br>
            </div>
        </div>
    </div>
    <!-- Détails chapitre 6 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingSeven">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
        ...
        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                <a href="actualvideocontent_learninglad.php?video=56">&#10170 C++ Object Oriented Programming Video
                    Tutorial</a><br>
                <a href="actualvideocontent_learninglad.php?video=57">&#10170 C++ OOPS Video Tutorials for Beginners |
                    Class Properties, Methods, Members</a><br>
                <a href="actualvideocontent_learninglad.php?video=58">&#10170 Creating Objects from a Class in Different
                    Ways </a><br>
                ...
                <a href="actualvideocontent_learninglad.php?video=65">&#10170 C++ Destructors to Release Resources with
                    example</a><br>
                <a href="actualvideocontent_learninglad.php?video=66">&#10170 C++ Static Variables and Members in
                    Class </a><br>
                ...
                <a href="actualvideocontent_learninglad.php?video=69">&#10170 Inheritance, Poly Morphism |
                    Introduction</a><br>
                <a href="actualvideocontent_learninglad.php?video=76">&#10170 Order of Execution of Constructors and
                    Destructors in Inheritance in C++</a><br>
                <a href="actualvideocontent_learninglad.php?video=81">&#10170 C++ this Keyword </a><br>
                <a href="actualvideocontent_learninglad.php?video=84">&#10170 C++ Virtual Function | Inherited
                    Attributes, Hierarchical Nature </a><br>
                <a href="actualvideocontent_learninglad.php?video=85">&#10170 C++ Pure Virtual Functions, Abstract
                    Classes</a><br>
                <a href="actualvideocontent_learninglad.php?video=86">&#10170 C++ Diamond problem in OOPS, Solution
                    using Virtual Inheritance with Example</a><br>
    ...
    <!-- Détails chapitre 7 -->
    <div class="overflow-hidden shadow-full mb-4 bg-transparent border-none relative flex flex-col rounded-md">
        <div class="bg-transparent border-none py-2 px-4" id="headingEight">
            <h2 class="mb-0">
                <button class="cursor-pointer w-full h-16 text-black font-bold text-left block bg-transparent border-0 px-4 py-2 text-base rounded-md outline-none" type="button" data-toggle="collapse"
                        data-target="#collapseEight" aria-expanded="false" aria-controls="collapseFour">
        ...
        <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordionExample">
            <div class="bg-gray-100 p-4 child-link-blue">
                <a href="actualvideocontent_learninglad.php?video=98">&#10170 Introduction to Exception Handling | try,
                    catch and throw </a><br>
                <a href="actualvideocontent_learninglad.php?video=101">&#10170 Functions Throwing Exceptions</a><br>
                <a href="actualvideocontent_learninglad.php?video=103">&#10170 Creating Custom, User Defined Exception
                    Class</a><br>
            </div>
        </div>
    </div>
