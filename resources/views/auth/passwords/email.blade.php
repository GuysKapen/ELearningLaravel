    ...
    <div
            ...
            <div class="lg:w-6/12 sm:w-8/12 flex flex-col items-center w-11/12 mt-8">
                    ...
                    <div class="bg-green-100 p-4 mb-4 rounded-md">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex flex-col items-start justify-start">
                                <span class="text-sm font-black text-green-800">Success</span>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="max-w-xs relative mx-auto">
                        ...
                        <div class="w-full d-flex justify-content-center mt-4">
                            ...
                            <button type="submit"
                                ...
                                <i class="fa fa-sign-in mr-3 duration-500"></i>{{ __('Send Link') }}
                            </button>
        ...
        <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
            <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat background-login flex items-center">
                <img src="{{asset("images/forget.svg")}}" alt="Image" class="img-fluid">
            </div>
        </div>
    </div>
@endsection
